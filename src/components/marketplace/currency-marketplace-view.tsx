                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3">
                                <div className="relative w-full sm:w-auto">
                                    ...
                                    <input
                                        ...
                                        className="h-10 w-full sm:w-64 bg-[#0d1117]/80 backdrop-blur-sm border border-[#30363d] rounded-lg pl-10 pr-4 text-xs text-white focus:border-[#f5a623] focus:outline-none transition-all placeholder:text-[#8b949e]"
                                    />
                                </div>
                                <Button variant="outline" size="sm" className="h-10 w-full sm:w-auto border-[#30363d] bg-[#0d1117]/80 backdrop-blur-sm text-[#8b949e] hover:text-white hover:bg-[#1c2128]">
