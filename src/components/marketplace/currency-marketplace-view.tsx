            ...
            <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div className="flex items-center gap-6">
                        {game?.icon && (
                            <Avatar className="h-20 w-20 rounded-2xl bg-[#0d1117] border border-[#30363d] p-3">
                                <AvatarImage src={game.icon} alt={game.name} />
                                <AvatarFallback className="bg-[#1c2128]">
                                    {game.name?.charAt(0)}
                                </AvatarFallback>
                            </Avatar>
                        )}
                        <div>
                            ...
                            <p className="text-[#8b949e] max-w-2xl text-sm leading-relaxed">
                                Buy {game?.name} {category.name} safely from verified pros. Instant delivery, best rates, and 24/7 support.
                            </p>
                        </div>
                    </div>

                    <div className="flex items-center gap-3">
                        <div className="px-5 py-2.5 rounded-xl bg-[#0d1117] border border-[#30363d] flex flex-col">
                ...
                {recommendedListing && (
                    <div className="mb-16">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h2 className="text-[10px] font-black text-[#f5a623] uppercase tracking-[0.3em] flex items-center gap-3">
                ...
                <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 border-y border-[#30363d]/50">
                        <h2 className="text-lg font-black text-white uppercase tracking-tight">All Other Sellers</h2>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="h-10 w-64 bg-[#0d1117] border border-[#30363d] rounded-lg pl-10 pr-4 text-xs text-white focus:border-[#f5a623] focus:outline-none transition-all"
                                />
                            </div>
                            <Button variant="outline" size="sm" className="h-10 border-[#30363d] bg-transparent text-[#8b949e] hover:text-white hover:bg-[#1c2128]">
