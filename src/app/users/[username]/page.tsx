...
function UserProfileContent({ user }: UserProfileContentProps) {
    ...
    // Simple mapping: "Account" -> "accounts", "Currency" -> "currency"
    ...
    const updateUrl = (tab: string, category: string) => {
        ...
        // Map category id back to URL param format (e.g. "accounts" -> "Account")
        const catLabel = categories.find(c => c.id === category)?.label;
        // Simple heuristic: remove 's' or use label singular
