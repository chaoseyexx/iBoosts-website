    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight uppercase">Seller Dashboard</h1>
                ...
                {[
                    ...
                    <Card key={stat.label} className="p-6 bg-black/40 border-[#2d333b]">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="flex items-center text-[10px] font-black text-[#f5a623] bg-[#f5a623]/10 border border-[#f5a623]/20 px-2.5 py-1 rounded-full shadow-[0_0_10px_rgba(245,166,35,0.1)]">
            ...
            <Card className="bg-[#0b0f14] border-[#2d333b] overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="text-[10px] font-black text-[#8b949e] uppercase bg-black/40 tracking-wider">
                            <tr>
                            ...
                            {[
                                ...
                                <tr key={order.id} className="hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={cn(
                                            "inline-flex items-center px-2.5 py-1 rounded text-[10px] font-black uppercase tracking-widest",
